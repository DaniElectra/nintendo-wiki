...
There is one exception: for [`/<version>/contents_authorization_token_for_aauth/issue`](#post-versioncontents_authorization_token_for_aauthissue), the [dauth user agent](/docs/switch/dauth) is used instead.
